...
class EntryEngine:
    def __init__(self, kite, df_cache, paper_trade=False):
        self.kite = kite
    ...
    def run_cycle(self):
        ...
        for item in symbol_data_list:
            ...
            try:
                records = fetch_symbol_candles(self.kite, token, days=getattr(config, 'CANDLE_LOOKBACK_DAYS', 1))
...
def run_entry_cycle(kite, df_cache, paper_trade=False):
